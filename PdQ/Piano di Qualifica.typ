...
#import "meta.typ": Introduzione, QualitaProcesso, QualitaProdotto, ResocontoAttivitaVerifica, SpecificaTest, tabelle, data, title, abstract
...
#set page(paper: "a4",
  columns: 1,
  numbering: "1",
  header: [Gruppo 2 - Rod2Cod  #h(1fr) Data: #data #h(1fr) #title],
)
