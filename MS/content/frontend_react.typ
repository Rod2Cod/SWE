*React* è una libreria JavaScript sviluppata da Meta (ex. Facebook) per creare interfacce utente dinamiche e interattive. È particolarmente utile per sviluppare applicazioni web a pagina singola (SPA)
