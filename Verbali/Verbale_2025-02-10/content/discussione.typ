...
Come *alternativa* è stato proposto il framework *VueJS*, che possiede un pattern architetturale ben definito di tipo *MVVM*(Model View View Model) e che permette di sviluppare in modo più ordinato e strutturato. 
...
== Github Issues
Il gruppo si è poi confrontato sulle varie Issues *aperte* e su quelle *da chiudere*. Inolre ne sono state create delle *nuove* per le attività da svolgere.
...
Durante la riunione sono state inoltre inviate mail al prof. R. Cardin per delucidazioni in merito a commenti ricevuti sul documeti di Analisi dei requisiti e al prof. T. Vardanega per richiedere la possibilità di effetuare il colloquio per la seconda parte dell'RTB.
#decisioni(
  [
