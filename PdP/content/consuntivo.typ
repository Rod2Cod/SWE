...
== Requirements and Technology Baseline
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/1costi.png",height: 20%)
...
#pagebreak()
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/2costi.png",height: 20%)
  *Retrospective*:
...
#pagebreak()
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/3costi.png",height: 20%)
  *Retrospective*:
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/4costi.png",height: 20%)
  *Retrospective*:
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/5costi.png",height: 20%)
  *Retrospective*:
...
#pagebreak()
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/6costi.png",height: 20%)
  *Retrospective*:
...
=== Settimo periodo 28/01/2025 - 10/02/2025
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/7costi.png",height: 20%)
  *Retrospective*:
...
=== Ottavo periodo 11/02/2025 - 24/02/2025
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/8costi.png",height: 20%)
  *Retrospective*:
...
=== Nono periodo 25/02/2025 - 10/03/2025
  ...
  *Grafico a torta del budget speso e rimanente al termine del periodo.*
  #image("Graphs/C/9costi.png",height: 20%)
  *Retrospective*:
